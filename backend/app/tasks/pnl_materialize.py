    ...
    *,
    ...
    try:
        with acquire_lock(writer_lock, base_dir=duckdb_file.parent):
            return _materialize_pnl_facts_under_writer_lock(
                report_date=report_date,
        ...
        failed_record = CacheBuildRunRecord(
            ...
            cache_version=PNL_RESULT_CACHE_VERSION,
            lock=PNL_MATERIALIZE_LOCK.key,
            source_version=failure_context["source_version"],
            vendor_version="vv_none",
            rule_version=RULE_VERSION,
        ).model_dump()
...
def _materialize_pnl_facts_under_writer_lock(
    *,
    ...
    run_id: str,
    run: BuildRunRecord,
    formal_pnl_enabled: bool | None,
    formal_pnl_scope_json: str | None,
