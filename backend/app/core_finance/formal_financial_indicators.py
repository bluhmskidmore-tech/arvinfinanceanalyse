...
def _empty_contract(report_month: str) -> dict[str, Any]:
    ...
    return {
        ...
        "remediation": {
            ...
            "readback_acceptance": _readback_acceptance(normalized_month),
...
def _readback_acceptance(report_month: str) -> dict[str, str]:
    return {
        "label": "登记后回读验收",
        "readback_query": f"report_month={report_month} 必须返回已登记契约",
