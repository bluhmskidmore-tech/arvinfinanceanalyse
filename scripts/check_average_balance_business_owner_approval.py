...
DEFAULT_TEMPLATE = ROOT / "docs" / "pnl" / "average-balance-business-owner-approval-template.md"
EXPECTED_OWNER_EVIDENCE_PACKET = "docs/pnl/average-balance-owner-evidence-packet.md"
...
ACTION_ITEM_DEFINITIONS = {
    ...
    "daily_golden_sample_review": {
        "template_field": "- Daily ADB golden sample reviewed",
        "required_value": "yes",
    },
    ...
    "formal_balance_truth_boundary_acceptance": {
        "template_field": "- Formal balance truth boundary accepted",
        "required_value": "yes",
    },
...
def _approval_blockers(
    ...
    *,
    ...
    review_fields = {
        ...
        "- Daily ADB golden sample reviewed": "daily_golden_sample_review",
        ...
        "- Formal balance truth boundary accepted": "formal_balance_truth_boundary_acceptance",
        "- Monthly ADB/NIM boundary accepted": "monthly_adb_nim_boundary_acceptance",
    }
...
def _approval_field_status(
    ...
    *,
    ...
    return {
        ...
        "daily_golden_sample_review": _review_status(text, "- Daily ADB golden sample reviewed"),
        ...
        "formal_balance_truth_boundary_acceptance": _review_status(
            text,
            "- Formal balance truth boundary accepted",
        ),
        "monthly_adb_nim_boundary_acceptance": _review_status(
            text,
            "- Monthly ADB/NIM boundary accepted",
        ),
        ...
        "certification_effect": (
            "valid" if _extract_scope_assignment(text, "certification_effect") == "none" else "missing"
        ),
    }
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Read the average-balance business-owner approval template and report its current status.",
    )
    parser.add_argument(
        "--template-path",
        type=Path,
