...
def product_page_trace_bundles() -> dict[str, dict[str, Any]]:
    product_category_bundle = {
        ...
        "contract_docs": [
            ...
            "docs/pnl/product-category-pnl-first-certification-packet.md",
            "docs/pnl/product-category-pnl-owner-decision-packet.md",
            "docs/pnl/product-category-pnl-business-owner-approval-template.md",
            "docs/pnl/product-category-pnl-approval-runbook.md",
        ...
        "truth_chain": [
            ...
            "docs/pnl/product-category-pnl-first-certification-packet.md packages source-to-screen evidence without approving certification.",
            "docs/pnl/product-category-pnl-owner-decision-packet.md lists pending product/API owner decisions without capturing them.",
            "docs/pnl/product-category-pnl-business-owner-approval-template.md is the only owner approval checker input and remains unsigned.",
            "docs/pnl/product-category-pnl-approval-runbook.md lists the review path while preserving business_owner_approval_captured=false and closure_approved=false.",
        ],
        "backend_touchpoints": [
            "backend/app/services/product_category_source_service.py",
    ...
    balance_analysis_bundle = {
        ...
        "contract_docs": [
            ...
            "docs/pnl/balance-analysis-owner-evidence-packet.md",
            "docs/pnl/balance-analysis-business-owner-approval-template.md",
            "docs/pnl/balance-analysis-owner-signoff-runbook.md",
            "docs/audits/2026-06-07-balance-analysis-live-smoke-evidence.md",
        ],
        "truth_chain": [
            ...
            "docs/pnl/balance-analysis-owner-evidence-packet.md packages owner-review evidence without approving page closure.",
            "docs/pnl/balance-analysis-business-owner-approval-template.md captures pending owner fields while preserving formal_use_allowed=true and closure_approved=false.",
            "docs/pnl/balance-analysis-owner-signoff-runbook.md lists the human review, fill, and post-signing verification commands without approving closure.",
            "docs/audits/2026-06-07-balance-analysis-live-smoke-evidence.md is live-smoke and verification reference evidence only; it does not approve closure, owner sign-off, or golden samples.",
            "/ui/balance-analysis/overview",
    ...
    average_balance_bundle = {
        ...
        "contract_docs": [
            ...
            "docs/metric_dictionary.md",
            "docs/page_contracts.md",
            "docs/pnl/average-balance-owner-evidence-packet.md",
            "docs/pnl/average-balance-business-owner-approval-template.md",
        ...
        "truth_chain": [
            ...
            "docs/audits/2026-06-09-average-balance-live-smoke-evidence.md is live-smoke reference evidence only; it does not approve closure, owner sign-off, formal balance truth, or monthly ADB/NIM.",
            ...
            "tests/golden_samples/GS-AVERAGE-BALANCE-MONTHLY-A freezes selected GET /api/analysis/adb/monthly candidate DTO evidence and remains captured-awaiting-approval.",
        ...
        "verification_focus": [
            ...
            "GS-AVERAGE-BALANCE-MONTHLY-A is a dedicated capture-ready monthly ADB/NIM DTO sample for MTR-ADB-003; verify selected monthly and YTD fields without treating it as metric approval.",
    ...
    bank_ledger_dashboard_bundle = {
        ...
        "truth_chain": [
            ...
            "GET /api/ledger/dashboard returns as_of_date plus currency_breakdown buckets containing currency (including UNKNOWN), asset_face_amount, liability_face_amount, and net_face_exposure; alert_count is removed.",
            ...
            "Rows outside the imported issuance category are defaulted to candidate asset, which remains a candidate classification risk.",
            "source_version, rule_version, batch_id, stale, fallback, no_data, requested/resolved dates, normalized filters, position keys, and row numbers remain traceable.",
            "PAGE-BANK-LEDGER-001 has no approved MTR binding, no dedicated golden sample, and no owner approval.",
        ],
        "backend_touchpoints": [
        ...
        "golden_samples": [],
        "verification_focus": [
            "No dedicated golden sample is registered for PAGE-BANK-LEDGER-001; verify Ledger API, page model, page, client, route registry, governance, and MCP tests.",
            ...
            "Check CNY/USD/UNKNOWN separation, null-vs-zero behavior, past-only fallback, no-earlier no_data, batch/source/rule metadata, and import-success refetch.",
            "Verify direction drill, positions query key/request, and export retain the selected currency without frontend aggregation.",
        ],
        "guardrails": [
            ...
            "Keep default-to-asset and UNKNOWN currency risks visible until golden evidence, manual lineage audit, and owner approval exist.",
    ...
    cashflow_projection_bundle = {
        ...
        "golden_samples": ["tests/golden_samples/GS-CASHFLOW-PROJECTION-A"],
        "verification_focus": [
            "Dedicated golden sample GS-CASHFLOW-PROJECTION-A is capture-ready pending approval and freezes candidate cashflow_projection.overview DTO evidence; it does not approve formal liquidity, risk, balance, or PnL truth.",
    ...
    ledger_pnl_bundle = {
        ...
        "contract_docs": [
            ...
            "docs/pnl/ledger-pnl-owner-evidence-packet.md",
            "docs/pnl/ledger-pnl-sign-off-packet.md",
            "docs/pnl/ledger-pnl-governance-audit-packet.md",
            "docs/pnl/ledger-pnl-business-owner-approval-template.md",
            "docs/pnl/ledger-pnl-owner-signoff-runbook.md",
        ],
        "truth_chain": [
            ...
            "docs/pnl/ledger-pnl-owner-evidence-packet.md packages owner-review evidence while preserving formal_use_allowed=false.",
            "docs/pnl/ledger-pnl-sign-off-packet.md is candidate sign-off evidence only and does not approve page closure.",
            "docs/pnl/ledger-pnl-business-owner-approval-template.md is the only owner approval checker input and remains unsigned.",
            "docs/pnl/ledger-pnl-owner-signoff-runbook.md lists the human review, fill, and post-signing verification commands without promoting Ledger PnL to formal PnL truth.",
        ],
        "backend_touchpoints": [
    ...
    pnl_attribution_workbench_bundle = {
        ...
        "contract_docs": [
            ...
            "docs/pnl/pnl-attribution-owner-signoff-runbook.md",
        ],
        "truth_chain": [
            ...
            "docs/pnl/pnl-attribution-owner-evidence-packet.md packages owner-review evidence while preserving formal_use_allowed=false.",
            "docs/pnl/pnl-attribution-sign-off-packet.md is candidate sign-off evidence only and does not approve page closure.",
            "docs/pnl/pnl-attribution-business-owner-approval-template.md is the only owner approval checker input and remains unsigned.",
            "docs/pnl/pnl-attribution-owner-signoff-runbook.md lists the human review, fill, and post-signing verification commands without promoting formal PnL truth.",
        ],
        "backend_touchpoints": [
    ...
    bond_analysis_bundle = {
        ...
        "contract_docs": [
            ...
            "docs/golden_sample_catalog.md",
            "docs/live_route_maturity.md",
            "docs/pnl/bond-analysis-owner-evidence-packet.md",
            "docs/pnl/bond-analysis-sign-off-packet.md",
            "docs/pnl/bond-analysis-governance-audit-packet.md",
            "docs/pnl/bond-analysis-business-owner-approval-template.md",
            "docs/pnl/bond-analysis-fixed-income-convention-decision-draft.md",
            "docs/pnl/bond-analysis-owner-signoff-runbook.md",
        ],
        "truth_chain": [
            ...
            "docs/pnl/bond-analysis-owner-evidence-packet.md packages owner-review evidence while preserving formal_use_allowed=false.",
            "docs/pnl/bond-analysis-sign-off-packet.md is candidate sign-off evidence only and does not approve page closure.",
            "docs/pnl/bond-analysis-business-owner-approval-template.md is the only owner approval checker input and remains unsigned.",
            "docs/pnl/bond-analysis-fixed-income-convention-decision-draft.md is review-only convention evidence and does not certify fixed-income metric truth.",
            "docs/pnl/bond-analysis-owner-signoff-runbook.md lists the human review, fill, and post-signing verification commands without promoting Bond Analysis to formal fixed-income metric truth.",
