...
const baseline = {
  ...
  maxPageStyleProps: {
    ...
    "frontend/src/features/cross-asset/pages/CrossAssetDriversPage.tsx": 40,
    "frontend/src/features/product-category-pnl/pages/ProductCategoryPnlPage.tsx": 38,
