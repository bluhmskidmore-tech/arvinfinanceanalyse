...
DEFAULT_TEMPLATE = ROOT / "docs" / "pnl" / "balance-analysis-business-owner-approval-template.md"
EXPECTED_SIGNOFF_PACKET = "docs/pnl/balance-analysis-sign-off-packet.md"
EXPECTED_GOVERNANCE_AUDIT_PACKET = "docs/pnl/balance-analysis-governance-audit-packet.md"
EXPECTED_OWNER_EVIDENCE_PACKET = "docs/pnl/balance-analysis-owner-evidence-packet.md"
...
ACTION_ITEM_DEFINITIONS = {
    ...
    "golden_sample_review": {
        "template_field": "- Golden sample `GS-BAL-OVERVIEW-A` reviewed",
        "required_value": "yes",
    },
...
def _approval_blockers(
    ...
    *,
    ...
    review_fields = {
        ...
        "- Golden sample `GS-BAL-OVERVIEW-A` reviewed": "golden_sample_review",
        ...
        "- Formal balance boundary accepted": "formal_balance_boundary_acceptance",
    }
...
def _approval_field_status(
    ...
    *,
    ...
    return {
        ...
        "golden_sample_review": _review_status(text, "- Golden sample `GS-BAL-OVERVIEW-A` reviewed"),
        ...
        "formal_balance_boundary_acceptance": _review_status(text, "- Formal balance boundary accepted"),
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Read the balance-analysis business-owner approval template and report its current status.",
    )
    parser.add_argument(
        "--template-path",
        type=Path,
