...
DEFAULT_TEMPLATE = ROOT / "docs" / "pnl" / "ledger-pnl-business-owner-approval-template.md"
EXPECTED_SIGNOFF_PACKET = "docs/pnl/ledger-pnl-sign-off-packet.md"
EXPECTED_GOVERNANCE_AUDIT_PACKET = "docs/pnl/ledger-pnl-governance-audit-packet.md"
EXPECTED_OWNER_EVIDENCE_PACKET = "docs/pnl/ledger-pnl-owner-evidence-packet.md"
...
def _approval_blockers(
    ...
    *,
    ...
    review_fields = {
        ...
        "- Dedicated ledger summary golden sample reviewed": "dedicated_golden_sample_review",
...
def _approval_field_status(
    ...
    *,
    ...
    return {
        ...
        "dedicated_golden_sample_review": _review_status(
            text,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Read the ledger-pnl business-owner approval template and report its current status.",
    )
    parser.add_argument(
        "--template-path",
        type=Path,
