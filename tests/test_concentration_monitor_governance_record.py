...
SCRIPT = ROOT / "scripts" / "emit_concentration_monitor_governance_record.py"
...
def test_concentration_monitor_governance_record_dry_run_preflights_without_writing(
    tmp_path: Path,
) -> None:
    ...
    assert payload["scope"] == "concentration-monitor-governance-record-generation"
    ...
    assert payload["evidence_scope"]["approves_formal_risk_truth"] is False
...
def test_concentration_monitor_governance_record_explicit_write_is_mcp_validated(
    tmp_path: Path,
) -> None:
    governance_dir = tmp_path / "governance"
...
def test_concentration_monitor_governance_record_write_is_idempotent(tmp_path: Path) -> None:
    governance_dir = tmp_path / "governance"
