...
const MOCK_CAPABILITY_RESULTS: MacroToolkitCapabilityResult[] = [
  ...
  },
  {
    ...
    result: {
      ...
      regime_label: "复苏",
      asset_scores: { 股票: 0.42, 债券: 0.11, 商品: -0.08, 现金: 0.05 },
      top_asset: "股票",
...
const MOCK_CAPABILITIES: MacroToolkitCapability[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      { alias: "M5525763", row_count: 1, latest_date: "2026-02-01", series_id: "EMM00191807" },
      { alias: "M0017126", row_count: 0, latest_date: null, series_id: null },
    ],
