      ...
      models: [
        {
          ...
          columns: ["资产", "合成信号", "趋势强度", "操作建议", "策略年化收益%", "策略夏普比率"],
          rows: [
            ["沪深300", "-0.82", "强", "做空", "12.34", "0.98"],
            ["中证500", "-0.76", "强", "做空", "10.87", "0.85"],
            ["国债期货", "0.18", "弱", "观望", "3.42", "0.61"],
            ["铜", "0.88", "强", "做多", "15.63", "1.12"],
            ["原油", "0.91", "强", "做多", "18.25", "1.04"],
          ],
        },
      ],
    },
