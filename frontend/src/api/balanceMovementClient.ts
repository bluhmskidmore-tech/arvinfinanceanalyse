    ...
    async getBalanceMovementAnalysis({ reportDate, currencyBasis = "CNX" }) {
      ...
      return buildMockApiEnvelope(
        "balance-analysis.movement.detail",
        {
          ...
          basis_movement_decomposition: {
            meta: {
              source_tables: ["product_category_pnl_canonical_fact"],
              source_scope: "总账科目 141/142/143/1440101，排除 144020 股权 OCI",
              report_date: reportDate,
              prior_report_date: "2026-01-31",
              currency_basis: currencyBasis,
              unit: "yuan",
              eligible_total: "335873309290.50",
              covered_total: "335873309290.50",
              unknown_total: "0",
              coverage_pct: "100.00",
              status: "supported",
              caveat:
                "这是科目余额层面的驱动拆解，不等同于单只资产会计分类迁移。",
            },
            buckets: [
              {
                basis_bucket: "AC",
                ...
                rows: [
                  {
                    component_key: "ac_142",
                    component_label: "142 摊余成本债权投资",
                    account_code_pattern: "142%",
                    previous_balance: "86000000000.00",
                    current_balance: "88400000000.00",
                    balance_change: "2400000000.00",
                    contribution_pct: "72.09",
                    source_note: "product_category_pnl_canonical_fact 科目余额",
                    is_supported: true,
                  },
                  {
                    component_key: "ac_143",
                    component_label: "143 债权投资",
                    account_code_pattern: "143%",
                    previous_balance: "53214376198.90",
                    current_balance: "54143803312.70",
                    balance_change: "929427113.80",
                    contribution_pct: "27.91",
                    source_note: "product_category_pnl_canonical_fact 科目余额",
                    is_supported: true,
                  },
                ],
              },
              {
                ...
                rows: [
                  {
                    component_key: "oci_1440101",
                    component_label: "1440101 债务工具 OCI",
                    account_code_pattern: "1440101%",
                    previous_balance: "101294750662.96",
                    current_balance: "105781745231.25",
                    balance_change: "4486994568.29",
                    contribution_pct: "100.00",
                    source_note: "144020 股权 OCI 已按页面口径剔除",
                    is_supported: true,
                  },
                ],
              },
              {
                ...
                rows: [
                  {
                    component_key: "tpl_141",
                    component_label: "141 交易性金融资产",
                    account_code_pattern: "141%",
                    previous_balance: "82384340890.05",
                    current_balance: "87547760746.55",
                    balance_change: "5163419856.50",
                    contribution_pct: "100.00",
          ...
          zqtz_maturity_structure: {
            meta: {
              source_tables: ["fact_formal_zqtz_balance_daily"],
              source_scope: "金融投资资产一级明细，不含 asset_zqtz_detail_* 子项和长期股权投资",
              report_date: reportDate,
              prior_report_date: "2026-01-31",
              currency_basis: currencyBasis,
              zqtz_currency_basis: "CNY",
              unit: "yuan",
              eligible_total: "337854709540.00",
              covered_total: "335000000000.00",
              unknown_total: "2854709540.00",
              coverage_pct: "99.15",
              status: "supported",
              caveat:
                "期限桶按当前报告日到 maturity_date 的天数划分；缺失到期日进入 unknown。",
            },
            buckets: [
              {
                maturity_bucket: "overdue_or_matured",
                bucket_label: "已到期/逾期",
                current_amount: "0",
                prior_amount: "0",
                delta_amount: "0",
              ...
              },
              {
                maturity_bucket: "<=30d",
                bucket_label: "30天内",
                current_amount: "20000000000.00",
                prior_amount: "18000000000.00",
                delta_amount: "2000000000.00",
                item_count: 4,
                share_pct: "5.92",
              },
              {
                maturity_bucket: "31-90d",
                bucket_label: "31-90天",
                current_amount: "35000000000.00",
                prior_amount: "30000000000.00",
                delta_amount: "5000000000.00",
                item_count: 8,
                share_pct: "10.36",
              },
              {
                maturity_bucket: "91d-1y",
                bucket_label: "91天-1年",
                current_amount: "80000000000.00",
                prior_amount: "76000000000.00",
                delta_amount: "4000000000.00",
                item_count: 15,
                share_pct: "23.68",
              },
              {
                ...
                bucket_label: "1-3年",
                current_amount: "120000000000.00",
                prior_amount: "112000000000.00",
                delta_amount: "8000000000.00",
                item_count: 22,
                share_pct: "35.52",
              },
              {
                ...
                bucket_label: "3-5年",
                current_amount: "60000000000.00",
                prior_amount: "58000000000.00",
                delta_amount: "2000000000.00",
                item_count: 12,
                share_pct: "17.76",
              },
              ...
              },
              {
                ...
                bucket_label: "未映射",
                current_amount: "2854709540.00",
                prior_amount: "2500000000.00",
                delta_amount: "354709540.00",
                item_count: 2,
                share_pct: "0.84",
              },
            ],
          ...
          zqtz_concentration_analysis: {
            meta: {
              ...
              unit: "yuan",
              eligible_total: "337854709540.00",
              covered_total: "330000000000.00",
              unknown_total: "7854709540.00",
              coverage_pct: "97.68",
              status: "supported",
              caveat:
                "集中度按当前期 Top 10 展示，Other 为非 Top 项，Unknown 为维度缺失项。",
            },
            dimensions: [
              {
                ...
                top_n: 10,
                hhi: "1620.35",
                top5_share_pct: "56.24",
                caveat: "主体缺失金额单列 Unknown，不并入 Other。",
                items: [
                  {
                    rank: 1,
                    dimension_value: "国家开发银行",
                    current_amount: "76000000000.00",
                    prior_amount: "70000000000.00",
                    delta_amount: "6000000000.00",
                    share_pct: "22.50",
                    item_count: 8,
                    item_kind: "top",
                  },
                  {
                    rank: 2,
                    dimension_value: "中国进出口银行",
                    current_amount: "52000000000.00",
                    prior_amount: "50000000000.00",
                    delta_amount: "2000000000.00",
                    share_pct: "15.39",
                    item_count: 6,
                    item_kind: "top",
                  },
                  {
                    ...
                    current_amount: "202000000000.00",
                    prior_amount: "193000000000.00",
                    delta_amount: "9000000000.00",
                    share_pct: "59.79",
                    item_count: 44,
                    item_kind: "other",
                  },
                  {
                    ...
                    current_amount: "7854709540.00",
                    prior_amount: "7000000000.00",
                    delta_amount: "854709540.00",
                    share_pct: "2.32",
                    item_count: 2,
                    item_kind: "unknown",
                  },
              ...
              },
              {
                ...
                status: "supported",
                eligible_total: "337854709540.00",
                covered_total: "337854709540.00",
                unknown_total: "0",
                coverage_pct: "100.00",
                prior_coverage_pct: "100.00",
                top_n: 10,
                hhi: "4124.18",
                top5_share_pct: "100.00",
                caveat: "评级维度覆盖当前 mock 全量。",
                items: [
                  {
                    rank: 1,
                    dimension_value: "AAA",
                    current_amount: "260000000000.00",
                    prior_amount: "245000000000.00",
                    delta_amount: "15000000000.00",
                    share_pct: "76.96",
                    item_count: 43,
                    item_kind: "top",
                  },
                  {
                    rank: 2,
                    dimension_value: "AA+",
                    current_amount: "77854709540.00",
                    prior_amount: "75000000000.00",
                    delta_amount: "2854709540.00",
                    share_pct: "23.04",
                    item_count: 17,
                    item_kind: "top",
                  },
              ...
              },
              {
                ...
                status: "supported",
                eligible_total: "337854709540.00",
                covered_total: "325000000000.00",
                unknown_total: "12854709540.00",
                coverage_pct: "96.19",
                prior_coverage_pct: "95.40",
                top_n: 10,
                hhi: "2345.76",
                top5_share_pct: "78.55",
                caveat: "行业缺失金额单列 Unknown。",
                items: [
                  {
                    rank: 1,
                    dimension_value: "金融业",
                    current_amount: "178000000000.00",
                    prior_amount: "170000000000.00",
                    delta_amount: "8000000000.00",
                    share_pct: "52.69",
                    item_count: 31,
                    item_kind: "top",
                  ...
                  {
                    rank: 2,
                    dimension_value: "公共管理",
                    current_amount: "82000000000.00",
                    prior_amount: "78000000000.00",
                    delta_amount: "4000000000.00",
                    share_pct: "24.27",
                    item_count: 12,
                    item_kind: "top",
                  },
                  {
                    rank: 0,
                    dimension_value: "Other",
                    current_amount: "65000000000.00",
                    prior_amount: "62000000000.00",
                    delta_amount: "3000000000.00",
                    share_pct: "19.24",
                    item_count: 15,
                    item_kind: "other",
                  },
                  {
                    rank: 0,
                    dimension_value: "Unknown",
                    current_amount: "12854709540.00",
                    prior_amount: "11000000000.00",
                    delta_amount: "1854709540.00",
                    share_pct: "3.80",
                    item_count: 2,
                    item_kind: "unknown",
                  },
