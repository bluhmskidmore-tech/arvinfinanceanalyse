...
export type ProductCategoryManualAdjustmentSortDir = "asc" | "desc";
...
export type ProductCategoryManualAdjustmentQuery = {
  ...
  currentSortDir?: ProductCategoryManualAdjustmentSortDir;
  eventSortField?: string;
  eventSortDir?: ProductCategoryManualAdjustmentSortDir;
