...
export const MOCK_CHOICE_MACRO_TUSHARE_EQUITY_SERIES: ChoiceMacroLatestPoint[] = [
  ...
  },
  {
    ...
    fetch_mode: "latest",
    fetch_granularity: "batch",
    policy_note: "Tushare index_daily pct_chg companion for CSI300 cross-asset display",
    latest_change: -0.05,
    recent_points: buildMockChoiceMacroRecentPoints("2026-04-10", 20, -0.42, 0.12, {
      source_version: "sv_tushare_index_daily_mock",
      vendor_version: "vv_tushare_index_dailybasic_000300SH_20260410",
    }),
  },
  ...
  },
  {
    ...
    trade_date: "2026-04-10",
    value_numeric: 101030,
    frequency: "daily",
    unit: "CNY/t",
    source_version: "sv_tushare_fut_daily_mock",
    vendor_version: "vv_tushare_fut_daily_CU_SHF_20260410",
    vendor_name: "tushare",
    refresh_tier: "stable",
    fetch_mode: "latest",
    fetch_granularity: "batch",
    ...
    latest_change: -600,
    recent_points: buildMockChoiceMacroRecentPoints("2026-04-10", 20, 101030, 1800, {
      source_version: "sv_tushare_fut_daily_mock",
      vendor_version: "vv_tushare_fut_daily_CU_SHF_20260410",
    }),
  },
  {
    ...
    unit: "CNY/t",
    source_version: "sv_tushare_fut_daily_mock",
    vendor_version: "vv_tushare_fut_daily_AL_SHF_20260410",
    vendor_name: "tushare",
    refresh_tier: "stable",
    fetch_mode: "latest",
    fetch_granularity: "batch",
    ...
    latest_change: -185,
    recent_points: buildMockChoiceMacroRecentPoints("2026-04-10", 20, 24430, 420, {
      source_version: "sv_tushare_fut_daily_mock",
      vendor_version: "vv_tushare_fut_daily_AL_SHF_20260410",
    }),
  },
