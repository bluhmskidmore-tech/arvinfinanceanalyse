/**
 * Balance movement demo/mock client slice.
 * Loaded only from mock composition paths (mockApiClient.ts /
 * homeSupplementalClient loadMockClient); keeps the large inline mock payload
 * out of the real-mode bundle that imports balanceMovementClient.ts.
 */
import type { BalanceMovementPayload } from "./contracts";
