/**
 * P&L by-business demo/mock client slice.
 * Loaded only from mock composition paths (mockApiClient.ts); keeps mock
 * payloads (including the Campisi decision-grade mock) out of the real-mode
 * bundle that imports pnlClient.ts.
 */
import { buildMockApiEnvelope } from "../mocks/mockApiEnvelope";
import type { PnlByBusinessInsightsPayload } from "./contracts";
import type { PnlBusinessClientMethods } from "./pnlClient";
