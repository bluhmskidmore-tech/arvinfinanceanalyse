                  ...
                  {data.items
                    ...
                    .map((item, idx) => (
                      ...
                      >
                        ...
                        >
                          {yiText(item.interaction_effect, 4)}
                        </td>
                        <td
                          style={{
                            textAlign: "right",
                        ...
                        >
                          {reconErrorText(item.recon_error)}
                        </td>
                      </tr>
                    ))}
                  {data.items
