...
const Q1_CALIBER_DECISION_LINES = [
  ...
  "外汇与衍生品室：外币资产负债按外币字段取数；汇兑损益及衍生聚合行暂不强行归属。",
  "代客交易：外汇远期/掉期仍需账户或产品明细拆出，当前聚合行只作待拆证据。",
          ...
          <span>
            {canLoadQ1CaliberEvidence
              ? q1CaliberLoading
                ...
                : q1CaliberError
                  ? "Q1证据加载失败"
                  : "Q1证据已按业务种类FTP后净损益与产品分类业务净收入/币种拆分展示；汇兑损益及衍生聚合行仅作待拆参考"
              : "Q1口径将按业务种类FTP后净损益与产品分类业务净收入/币种拆分展示；正式日期列表暂未同时满足2025底稿和2026Q1证据；汇兑损益及衍生聚合行仅作待拆参考"}
          </span>
        </div>
