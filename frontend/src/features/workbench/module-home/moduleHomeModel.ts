...
function portfolioView(
  ...
  const bondKpiDefs: Array<{
  ...
  }> = [
    {
      ...
      detail: "headline.total_market_value（元→亿元）。",
    },
    {
      key: "asset-market",
      label: "资产侧市值",
      customValue: formatYiFromYuan(balance?.asset_total_market_value_amount),
      detail: `balance overview 资产侧，${envelopeMeta(queries.balanceOverview)}`,
    ...
    },
    {
      ...
      detail: `balance overview 负债侧，${envelopeMeta(queries.balanceOverview)}`,
      tone: balance ? "ok" : "watch",
    },
    {
      key: "bond-duration",
      ...
      detail: "headline.weighted_duration。",
    },
    {
      key: "bond-ytm",
      label: "加权 YTM",
      field: "weighted_ytm",
      detail: "headline.weighted_ytm。",
    },
    {
      key: "bond-credit-spread",
      label: "信用利差中位数",
      field: "credit_spread_median",
      detail: "headline.credit_spread_median。",
    },
    {
      key: "bond-dv01",
      label: "DV01 合计",
      field: "total_dv01",
      detail: "headline.total_dv01（万元）。",
    },
    {
      key: "bond-credit-ratio",
      label: "信用占比",
      customValue: risk ? `${formatRatePercent(risk.credit_ratio)}%` : "-",
      detail: "risk-indicators.credit_ratio。",
      tone: risk ? "ok" : "watch",
    },
    {
      key: "bond-pnl",
      ...
      detail: "headline.unrealized_pnl（元→亿元）。",
    },
    {
      key: "bond-count",
      label: "持仓只数",
      field: "bond_count",
      detail: "headline.bond_count。",
    },
  ];
