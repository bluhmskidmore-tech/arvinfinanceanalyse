...
export const mockCampisiFourEffects: CampisiFourEffectsPayload = {
  ...
  decomposition_basis:
    "bridge_path: selection_effect is residual after carry, treasury, spread, realized_trading, manual_adjustment, and fx_translation; model_path: selection_effect is per-bond curve decomposition residual",
  totals: {
