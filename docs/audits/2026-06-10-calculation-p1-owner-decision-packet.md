...
| ---: | --- | --- |
| 1 | `P1-10`, `P1-11` | fastest remaining frontend/user-facing risk reduction once owner accepts the boundary. |
| 2 | `P1-02`, `P1-01`, `P1-05` | highest numeric magnitude risk. |
| 3 | `P1-03`, `P1-06` | narrative/sign quality risks that need explicit wording. |
