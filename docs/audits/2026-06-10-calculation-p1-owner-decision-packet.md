...
| `P1-07` | after polarity is approved, normalize `backend/app/core_finance/macro_bond_linkage.py` and the cross-asset derived narrative in `frontend/src/features/cross-asset/lib/`; regression should isolate liquidity movement while other components are neutral in `tests/test_macro_bond_linkage.py` and `frontend/src/features/cross-asset/lib/crossAssetAnalytics.test.ts`. | `backend/app/core_finance/macro_bond_linkage.py`, `frontend/src/features/cross-asset/lib/`, `tests/test_macro_bond_linkage.py`, `frontend/src/features/cross-asset/lib/crossAssetAnalytics.test.ts` |
