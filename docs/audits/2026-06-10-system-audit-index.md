...
| Local secret hygiene | `2026-06-10-local-secret-hygiene-snapshot.json`; `2026-06-10-local-secret-hygiene-runbook.md` | refreshed at 2026-06-10T15:45:10+08:00: OSV 0 vulnerabilities; redacted gitleaks still has 2 ignored/untracked `config/.env` findings by secret name only; values are not captured |
...
| `2026-06-10-local-secret-hygiene-snapshot.json` | Machine-readable local secret boundary status: secret names only, ignored/untracked file checks, OSV 0-vulnerability result, and redacted gitleaks 2-finding result. | Reading, rotating, clearing, approving, or committing secret values. |
